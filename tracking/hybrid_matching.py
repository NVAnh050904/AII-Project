...
def analyze_loocv_performance(loocv_results: list, chosen_weights: list, positive_events: list, negative_pairs: list):
    ...
    print("-" * 85)
    print(f"{'Micro Combined EER (12 events + 309 neg)':<40} | {reid_eer:18.2f}% | {hybrid_eer:20.2f}%")
    ...
    print("     Time Penalty did NOT change the final EER (remains 9.67% Micro / 13.70% Macro).")
...
def main():
    ...
    print(f"[INFO] Loaded {len(positive_events)} independent positive re-entry events across 4 videos.")
